...
### 🚀 Key Features
* **Dynamic Optimization Plan (DOP):** Generates actionable pivot strategies for complex disruptions.
...
AI Optimization: The flagged data is sent to the Gemini 3 Flash engine with a specific prompt to generate a pivot strategy.
...
User Input: Assumes the user provides specific disruption details to trigger the optimization engine.
